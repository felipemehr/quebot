...
$searchKeywords = ['busca', 'buscar', 'encuentra', 'encontrar', 'parcelas', 'propiedades', 'terrenos', 'casas', 'departamentos', 'noticias', 'precio', 'dólar', 'clima', 'actualidad'];
$shouldSearch = false;
...
"Cuando respondas sobre propiedades o búsquedas geográficas, puedes incluir datos para mostrar un mapa.\n" .
...
"Los URLs DEBEN ser los reales de los resultados de búsqueda.";
